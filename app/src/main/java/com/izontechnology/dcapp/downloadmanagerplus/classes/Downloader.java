package com.izontechnology.dcapp.downloadmanagerplus.classes;


import static com.izontechnology.dcapp.downloadmanagerplus.utils.Strings.DOWNLOAD_DEFAULT_DIRECTORY;
import static com.izontechnology.dcapp.downloadmanagerplus.utils.Utils.createDirectory;
import static com.izontechnology.dcapp.downloadmanagerplus.utils.Utils.getAppTargetSdkVersion;
import static com.izontechnology.dcapp.downloadmanagerplus.utils.Utils.isIdEmpty;
import static com.izontechnology.dcapp.downloadmanagerplus.utils.Utils.isValidDefaultDirectory;
import static com.izontechnology.dcapp.downloadmanagerplus.utils.Utils.isValidDirectory;
...
import com.izontechnology.dcapp.downloadmanagerplus.model.DownloadManagerHeader;
import com.izontechnology.dcapp.downloadmanagerplus.utils.Constants;
import com.izontechnology.dcapp.downloadmanagerplus.utils.Log;
import com.izontechnology.dcapp.downloadmanagerplus.utils.Strings;
        ...
        if (isDownloadRunning()) {
            if (mListener != null) {
                if (mDownloadStatus == DownloadStatus.SUCCESSFUL)
                    mListener.onComplete(mTotalBytes, mDownloadInfo,mLocalUri);
                else
        ...
        switch (mDownloadStatus) {
            case SUCCESSFUL:
                if (mDownloadInfo != null)
                    mDownloadInfo.setLocalUri(mLocalUri);
                mListener.onComplete(mTotalBytes, mDownloadInfo,mLocalUri);
                break;
            case PAUSED:
